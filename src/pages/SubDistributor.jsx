...
const MARKETING_COPY = {
  ...
  en: {
    eyebrow: 'Branded AI API Platform',
    heroTitle: 'Launch your own AI API platform for models, plans, and top-ups',
    heroDesc: 'Upstream model access, VPS hosting, payments, and admin basics are already handled. Pay one setup fee to launch a branded AI API management platform with its own entry point, pricing, promotion, and payments.',
    primaryCta: 'Launch My AI API Platform',
    secondaryCta: 'See Who It Fits',
    proof: ['Branded entry point', 'OpenAI-compatible API', 'Automatic access after payment'],
    audienceTitle: 'Who It Fits',
    audienceDesc: 'Built for people who already have users, communities, clients, or model supply and want to package AI API access as their own service.',
    audience: [
      ...
      ['Model channels and API resellers', 'Turn multi-model access into your own branded platform with pricing, packages, payments, and promotion.'],
    ...
    revenueDesc: 'This is not just an admin account. It gives you a sellable AI API service to operate.',
    revenue: [
      ['Set model price margins', 'Configure prices by model, channel, or plan so usage can cover cost and leave margin.'],
      ['Sell plans and redeem codes', 'Offer day, week, month, or quota-based access for communities, teams, and short-term power users.'],
    ...
    savingsTitle: 'What You Avoid Building',
    ...
    included: [
      'Independent entry point and branded presentation',
