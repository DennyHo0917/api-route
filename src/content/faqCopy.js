export const FAQ_COPY = {
  zh: {
    ...
    cards: [
      ...
      { title: '选择套餐', body: '按天、周、月或额度购买。', to: '/pricing/packages' },
    ],
    contactTitle: '还有问题？',
  ...
  en: {
    ...
    cards: [
      ...
      { title: 'Choose a Plan', body: 'Buy by day, week, month, or quota.', to: '/pricing/packages' },
    ],
  ...
  ja: {
    ...
    cards: [
      ...
      { title: 'プランを選ぶ', body: '日・週・月・容量から選択。', to: '/pricing/packages' },
    ],
  ...
  ko: {
    ...
    cards: [
      ...
      { title: '플랜 선택', body: '일, 주, 월, 용량 기준으로 구매.', to: '/pricing/packages' },
    ],
