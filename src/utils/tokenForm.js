...
export const isAutoGeneratedToken = (token) => /-auto-\d+$/.test(token?.name || '');

export const hasUserApiKey = (tokens) => (
  Array.isArray(tokens) && tokens.some((token) => !isAutoGeneratedToken(token))
);
